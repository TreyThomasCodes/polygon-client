...
/// <summary>
/// Request object for retrieving historical trade data for a specific options contract.
/// Supports pagination and time-based filtering.
/// </summary>
public class GetTradesRequest
{
    /// <summary>
    /// Gets or sets the options ticker symbol in OCC format (e.g., "O:TSLA210903C00700000").
    ...
    /// <summary>
    /// Gets or sets the timestamp to query for trades at or after this time.
    /// Can be a date (YYYY-MM-DD), datetime (YYYY-MM-DDTHH:MM:SS), or nanosecond timestamp.
    /// </summary>
    public string? Timestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp to query for trades before this time.
    /// Can be a date (YYYY-MM-DD), datetime (YYYY-MM-DDTHH:MM:SS), or nanosecond timestamp.
    /// </summary>
    public string? TimestampLt { get; set; }

    /// <summary>
    /// Gets or sets the timestamp to query for trades at or before this time.
    /// Can be a date (YYYY-MM-DD), datetime (YYYY-MM-DDTHH:MM:SS), or nanosecond timestamp.
    /// </summary>
    public string? TimestampLte { get; set; }

    /// <summary>
    /// Gets or sets the timestamp to query for trades after this time.
    /// Can be a date (YYYY-MM-DD), datetime (YYYY-MM-DDTHH:MM:SS), or nanosecond timestamp.
    /// </summary>
