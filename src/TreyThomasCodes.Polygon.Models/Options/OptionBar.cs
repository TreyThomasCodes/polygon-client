...
/// <summary>
/// Represents an aggregate (OHLC) bar for an options contract.
...
public class OptionBar
{
    ...
    /// The total number of contracts traded during the aggregate window.
    /// </summary>
    [JsonPropertyName("v")]
    ...
    /// Expressed as milliseconds since the Unix epoch in the market's location (January 1, 1970 EST for US markets).
    /// </summary>
    [JsonPropertyName("t")]
